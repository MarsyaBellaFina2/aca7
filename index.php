        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade <?php echo SetContentPage("1", $link_page) ?>" id="beasiswa" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="section-menu">
                    ...
                    <p>Beasiswa adalah bentuk bantuan keuangan yang diberikan untuk membantu penerimanya dalam mengejar pendidikan sesuai bidang yang mereka kuasai</p>
                    <ol>
                        <li>
                            <h5>Beasiswa Akademik</h5>
                            <p>Beasiswa akademik adalah jenis beasiswa yang diberikan karena prestasi dalam bidang akademik dan berkomitmen untuk mempertahankan prestasi tersebut.</p>
                            ...
                            <a class="btn btn-info btn-sm my-sm-btn" style="background-color:pink;" href="index.php?link_page=2&jenis_beasiswa=akademik">Daftar Sekarang</a>
                        </li>
                        <li>
                            <h5>Beasiswa Non Akademik</h5>
                            <p>Non akademik ini merupakan kemampuan yang tidak memiliki hubungan dengan ilmu pengetahuan dan memiliki sifat ilmiah</p>
                            <p>Adapun persyaratan yang dibutuhkan adalah:</p>
                            <ul>
                                <li>
                                    <p>Warga Negara Indonesia</p>
                                ...
                                <li>
                                    <p>Nilai Akademik yang cukup tinggi</p>
                                </li>
                                <li>
                                    <p>Prestasi Ekstrakurikuler</p>
                                </li>
                            </ul>
                            <p>untuk informasi selengkapnya silahkan klik tombol dibawah ini:</p>
                            <a class="btn btn-info btn-sm my-sm-btn" style="background-color:pink;" href="index.php?link_page=2&jenis_beasiswa=non_akademik">Daftar Sekarang</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="tab-pane fade <?php echo SetContentPage("2", $link_page) ?>" id="daftar" role="tabpanel" aria-labelledby="nav-profile-tab">
                <div class="section-menu">
                    ...
                    <form action="add_pendaftar.php" method="post" enctype="multipart/form-data">
                        ...
                        <input class="btn btn-info btn-sm" style="background-color:pink;" type="submit" value="Daftar" <?php echo SetDisable($ipk) ?>>
                        <a class="btn btn-warning btn-sm" style="background-color:hotpink" href="index.php?link_page=2">Batal</a>
                    </form>
                </div>
            </div>
